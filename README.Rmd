...
We run simulations for 3 levels of sampling intensity (150, 300, and 600 ARU survey locations), and for 3 levels of population density (n_males = 500, 1000, and 2000) which corresponds to population densities of `r round(500/plot_area,2)`, `r round(000/plot_area,2)`, and `r round(2000/plot_area,2)` males/km<sup>2</sup>.
